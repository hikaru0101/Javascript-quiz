...
// Ans:D
// Short explanation: var and let are declared after consoles.
```
...
// Ans:C
// Short explanation:2 is String, so just they are concatnated.
```
...
// Ans: B
// Short explanation: 3+4=7 and this will be concatnated with string, 5.
```
...
// Ans:D
// Short explanation: it actually  returned undefined.
```
...
// Change s1 and s2
// first to lowercase.The indexOf() method is case sensitive.
// Then use the
// indexOf method.

let firstString = s1.toLowerCase();
let secondString = s2.toLowerCase();
console.log(firstString.indexOf(secondString));
